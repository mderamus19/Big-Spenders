...
//   outEl.innerHTML += "<hr/>"
// });
const outStateNY = document.querySelector("#state")

outStateNY.innerHTML = "<h1>New York Businesses</h1>"
...
outStateNY.innerHTML += `<h2>${newYorkBusinesses}</h2>`
console.log(newYorkBusinesses.addressStateCode)
